...
# define BOARD_FORCE_BL_PIN				GPIO9
# define BOARD_FORCE_BL_PORT			GPIOA
# define BOARD_FORCE_BL_CLOCK_REGISTER	RCC_AHB1ENR
# define BOARD_FORCE_BL_CLOCK_BIT		RCC_AHB1ENR_IOPAEN
# define BOARD_FORCE_BL_PULL			GPIO_PUPD_PULLUP
...
# define BOARD_PRESENCE_PIN				GPIO4
# define BOARD_PRESENCE_PORT			GPIOD
# define BOARD_PRESENCE_CLOCK_REGISTER	RCC_AHB1ENR
# define BOARD_PRESENCE_CLOCK_BIT		RCC_AHB1ENR_IOPDEN
# define BOARD_PRESENCE_PULL			GPIO_PUPD_PULLDOWN
#endif
...
#ifdef BOARD_VRBRAINV53
# define BOARD_TYPE					1153
# define BOARD_REVISION				0
# define BOARD_VERSION				5.3
# define BOARD_FLASH_SECTORS		11
# define BOARD_FLASH_SIZE			(1024 * 1024)
...
# define BOARD_PRESENCE_PIN				GPIO11
# define BOARD_PRESENCE_PORT			GPIOC
# define BOARD_PRESENCE_CLOCK_REGISTER	RCC_AHB1ENR
# define BOARD_PRESENCE_CLOCK_BIT		RCC_AHB1ENR_IOPCEN
# define BOARD_PRESENCE_PULL			GPIO_PUPD_PULLDOWN
#endif
